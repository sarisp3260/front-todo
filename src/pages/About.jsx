  ...
  return (
    ...
    <div className='grid w-full gap-10 justify-items-center'>
      <div className='h-full w-10/12 flex flex-col md:flex-row gap-5'>
        ...
        <div className='w-full bg-white/90 py-5 px-10 text-center flex flex-col items-center justify-center gap-5 rounded-xl backdrop-blur-lg shadow-xl md:w-1/3'>
